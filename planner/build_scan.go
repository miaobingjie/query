...
func (this *builder) processPredicate(pred expression.Expression, isOnclause, outerOnly bool) (
	value.Value, error) {

	return ClassifyExpr(pred, this.baseKeyspaces, this.keyspaceNames, isOnclause, outerOnly,
		this.useCBO, this.advisorValidate(), this.context)
}

func (this *builder) processWhere(where expression.Expression) (err error) {
	var constant value.Value
	constant, err = this.processPredicate(where, false, false)
	if err != nil {
		return
	}
